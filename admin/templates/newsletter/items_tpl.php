...
$('.timkiem button').click(function(event) {
	...
	window.location.href="index.php?com=newsletter&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>&keyword="+keyword;
});
...
<form name="frm" method="post"  action="index.php?com=newsletter&act=send<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" enctype="multipart/form-data" id="f">	
...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
        ...
        <td><div>SĐT<span></span></div></td>
        <td><div>Nội dung<span></span></div></td>
	...
	<tr style="text-align:center">
		...
		<td style="width:15%;" align="center"><?=$i+1?></td>	
		<td style="width:20%;" align="center"><b><?=$items[$i]['ten']?></b></td>	        
        <td style="width:20%;" align="center"><b><?=$items[$i]['email']?></b></td>
        <td style="width:10%;" align="center"><b><?=$items[$i]['dienthoai']?></b></td>
        <td style="width:50%;" align="center"><b><?=$items[$i]['noidung']?></b></td>
		
		<td style="width:20%;"><a href="index.php?com=newsletter&act=delete&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="./images/icons/dark/close.png" alt=""></a></td>
