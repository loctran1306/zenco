	...
	<div class="widget">
		...
		<?php if($config_images=='true') {?>
			...
			<div class="formRow">
				...
				<div class="mt10"><img src="<?=_upload_hinhanh.$item['thumb']?>"  alt="NO PHOTO" width="200" /></div>
			...
			<div class="formRow">
				...
				<div class="mt10">
					<video width="400" controls>
					  ...
					  <source src="<?=_upload_hinhanh?><?=$$item['video']?>" type="video/ogg">
					</video>
				</div>
				<div class="clear"></div>
			</div>
