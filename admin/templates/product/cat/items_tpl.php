  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <?php if($config_trangchu=='true') {?>
        <td align="center">
          <a data-val2="table_<?=$_GET['com']?>_cat" rel="<?=$items[$i]['trangchu']?>" data-val3="trangchu" class="diamondToggle <?=($items[$i]['trangchu']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a>   
        </td>
        <?php } ?>
        <?php if($config_noibat=='true') {?>
        <td align="center">
