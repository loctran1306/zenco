  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <td class="tb_data_small">Khuyễn mãi</td>
        <?php } ?>
    ...
    <tbody>
       ...
       <td>
        ...
        <td class="center">
            <a href="index.php?com=product&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id_sub=<?=$items[$i]['id_sub']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" class="tipS SC_bold"><img src="<?=_upload_product?><?=$items[$i]['thumb']?>" width="50" onerror="this.src='http://placehold.it/263x209/000/fff';" ></a>
        </td>

        <?php if($config_new=='true') {?>
        <td align="center">
        <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['new']?>" data-val3="new" class="diamondToggle <?=($items[$i]['new']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td>
        <?php } ?>
        ...
        <?php if($config_km=='true') {?>
        <td align="center">
        <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['khuyenmai']?>" data-val3="khuyenmai" class="diamondToggle <?=($items[$i]['khuyenmai']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td>
        <?php } ?>
        <td align="center">
