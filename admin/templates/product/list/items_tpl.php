  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <?php if($config_intro== "true") {?>
         <td align="center">
        <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['new']?>" data-val3="new" class="diamondToggle <?=($items[$i]['new']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td>
       <?php } ?>
        <?php if($config_noibat== "true") {?>
         <td align="center">
